...
def process_hud_alert(enabled, fingerprint, visual_alert, left_lane,
  ...
  if left_lane_depart:
    left_lane_warning = 1 if fingerprint in [CAR.NEXO, CAR.GENESIS, CAR.GENESIS_G70, CAR.GENESIS_G80,
                                             CAR.GENESIS_EQ900, CAR.GENESIS_EQ900_L] else 2
  if right_lane_depart:
    right_lane_warning = 1 if fingerprint in [CAR.NEXO, CAR.GENESIS, CAR.GENESIS_G70, CAR.GENESIS_G80,
                                              CAR.GENESIS_EQ900, CAR.GENESIS_EQ900_L] else 2
